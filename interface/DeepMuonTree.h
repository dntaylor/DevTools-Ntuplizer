#ifndef DeepMuonTree_h
#define DeepMuonTree_h
...
class DeepMuonTree : public edm::one::EDAnalyzer<edm::one::SharedResources> {
  public:
    explicit DeepMuonTree(const edm::ParameterSet&);
    ~DeepMuonTree();
...
void DeepMuonTree::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(DeepMuonTree);
