#include "DevTools/Ntuplizer/interface/DeepMuonTree.h"
...
DeepMuonTree::DeepMuonTree(const edm::ParameterSet &iConfig) :
    ...
    muonAssociation_(iConfig.getParameter<edm::ParameterSet>("muonAssociation"))
{
    ...
    // create tree_
    tree_ = FS->make<TTree>("DeepMuonTree", "DeepMuonTree");
...
DeepMuonTree::~DeepMuonTree() { }

void DeepMuonTree::beginJob() { }

void DeepMuonTree::endJob() { }

void DeepMuonTree::analyze(const edm::Event &iEvent, const edm::EventSetup &iSetup) {
